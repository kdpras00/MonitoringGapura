...
<x-filament-panels::layout.base :livewire="$livewire">
    ...
    <div class="fi-simple-layout flex min-h-screen flex-col items-center">
        ...
        >
            <main
                @class([
                    'fi-simple-main my-16 w-full px-6 py-12 sm:rounded-xl sm:px-12',
            ...
            >
                <div class="text-center mb-8">
                    <img 
                        src="{{ config('filament.brand_logo_url') ?? asset('images/logo-gapura.png') }}" 
                        alt="{{ config('app.name') }}" 
                        class="h-16 mx-auto"
                    />
                </div>
        ...
        <div class="fixed bottom-4 text-center w-full text-white opacity-80 text-sm">
            &copy; {{ date('Y') }} PT Gapura Angkasa - Sistem Monitoring Perawatan
        </div>
